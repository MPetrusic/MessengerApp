...
class RegisterViewController: UIViewController {
    ...
    @objc private func loginButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                strongSelf.alertUserLoginError(message: "Looks like user account for that email address already exists.")
                return
            }
    ...
    func alertUserLoginError(message: String = "Please fill all of the required fields.") {
